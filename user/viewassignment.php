...
<div class="container-fluid pt-5" style="background-color:cadetblue">
    <h1 style="text-align:center;">All View Assignment</h1><hr style="margin-left: 535px; width:30%;height:5px;background-color:orange; border-radius: 20px; border: 2px solid orange;">
    <div class="row pt-3">
            ...
            $res = mysqli_query($conn,$query);
                ...
                <table class="table" style="background-color: burlywood;">
                    <tr>
                        ...
                        <th style="background-color: red;">Assignment</th>
                    </tr>
                    <?php
                ...
                <tr>
                    ...
                    <td>
                        <a href="../upload/assignment/<?php echo $row['assignment']; ?>">Download</a>
                    </td>
