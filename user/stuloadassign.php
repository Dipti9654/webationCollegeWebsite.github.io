...
<body>
    ...
    <div class="container-fluid pt-5" style="background-color:cadetblue">
        <h1 style="text-align:center;">Student Upload Note</h1>
        <hr
            style="margin-left: 535px; width:30%;height:5px;background-color:orange; border-radius: 20px; border: 2px solid orange;">
        <div class="row pt-3">
            <div class="col-sm-2" style="background-color:black;">
                <div class="navbar">
                    <ul>
                        <li class="form-control bg-success"><a href="./userdashboard.php" class="active">User Profile</a></li>
                        ...
                        <li class="form-control bg-success"><a href="userlogin.php">Logout</a></li>
                        <hr>
                    </ul>
                </div>
            </div>
            <div class="col-sm-10" style="background-color: burlywood;">
                <!--  -->
                <form action="stuploadassigndata.php" method="post"enctype="multipart/form-data"><br>
                    <label for="Sub"><b>Name</b></label>
                    <input class="form-control mt-2" type="text" name="name" id="Sub" />
                    <label for="Sub"><b>Subject</b></label>
                    <input class="form-control mt-2" type="text" name="subject" id="Sub" />
                    <label for="Assign"><b>Upload Assignment</b></label>
                    <input class="form-control mt-2" type="file" name="assignment" id="Assign" />
                    <input class="form-control mt-2 btn btn-success" type="submit" value="Upload" name="submit">
                </form>
                <!--  -->
            </div>
        </div>
