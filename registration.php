...
<head>
    ...
    <script>
        function validate()
        {
            ...
            else if(!expemail.test(emailaddress))
            {
            ...
            // {
            //     alert("Password must be atleast six chars");
            //     return false;
            // }
            ...
            {
                alert("Pleasr and Confirm password are not matched");
                return false;
            }
...
<h1 style="text-align:center;">Registration</h1><hr style="margin-left: 600px; width:20%;height:5px;background-color:red; border-radius: 20px; border: 2px solid red;">
<div class="row pt-3">
        <div class="col-sm-5">
            <img src="images/certificate2.png" width="600px" alt="">
        </div>
    <div class="col-sm-7" style="border-radius: 10px;background-color: burlywood;margin-bottom: 5%;
	padding: 20px 12px;box-sizing: border-box; transition: 0.5s;">
        <form name="myform" action="reg_data.php" method="post" onsubmit="return validate()" enctype="multipart/form-data">
            <b>Enter Name :</b>
            ...
            <input type="email" name="emailaddress" id="email" placeholder="Enter Email Id" class="form-control"/> <br/>
            <b>Enter Password :</b>
            <input type="password" name="password"placeholder="Enter Password"class="form-control" ><br>
            <b>Confirm Password :</b>
            <input type="password" name="conpassword"placeholder="Enter Password"class="form-control" ><br>
            <b>Enter Contact No :</b>
            <input type="number" name="contactno"placeholder="Enter Contact No"class="form-control" ><br>
            <label for="photo">**Uplaod Your Passport Size Photo in JPG/JPEG/PNG Format only</label>
            <input type="file" name="photo" id="photo" class="form-control" placeholder="Uplaod Your Passport Size Photo" accept="image/jpg, image/png, image/jpeg" required><br>
            ...
            <input type="submit" name="register" value="Register" class="btn btn-primary btn-lg text-align:center">
            </div>
        </form>
            <!-- <button class="btn btn-outline-danger" type="button" style=" border: 1px solid red; color:red;"  onclick="location.href='http://localhost/CollegeWebsite/index.php'">Explore Now</button> -->
        </div>
    </div>
</div>
<!-- about end  -->
