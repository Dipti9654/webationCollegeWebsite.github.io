...
<h1 style="text-align:center;">Enquiry Form</h1><hr style="margin-left: 600px; width:20%;height:5px;background-color:red; border-radius: 20px; border: 2px solid red;">
<div class="row pt-3">
       
        <div class="col-sm-5">
           <img src="images/enquery.jfif" width="600px" alt="">    
           <img src="images/gallery1.jpg" width="600px" alt="">    
        </div>
    ...
    <form  name="myform" action="enquiry.php" method="post" onsubmit="return validate()" enctype="multipart/form-data">
    <b>Enter Name:</b>
    ...
    <b>Enter Address :</b>
    <textarea name="address" id="" cols="30" rows="" placeholder="Enter Address"class="form-control"></textarea><br>
    ...
    <input type="email" name="emailaddress" placeholder="Enter Email Id" class="form-control"/> <br/>
    <b>Enquriy Details :</b>
    <textarea name="enquirytext" placeholder="Message" class="form-control" ></textarea> <br/>
    <div class="col-sm-12 pb-5" style="text-align:center">
    <input type="submit" name="submit" value="Submit" class="btn btn-primary btn-lg text-align:center">
    </div>
    </form>
        </div>
    </div>
