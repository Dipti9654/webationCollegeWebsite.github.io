...
<h1 style="text-align:center;">Admin Login</h1><hr style="margin-left: 600px; width:20%;height:5px;background-color:red; border-radius: 20px; border: 2px solid red;">
<div class="row pt-3">
        <div class="col-sm-5">
    ...
    <h1 style="text-align:center;color:red">Only for Admin login</h1>
    <form  action="log_data.php" method="post" enctype="multipart/form-data">
    ...
    <button class="btn btn-danger mt-3" style="width: 130px; margin-bottom:20px;" onclick="location.href='http://localhost/webationCollegeWebsite/./index.php'">Back</button>
        </div>
    </div>
</div>
