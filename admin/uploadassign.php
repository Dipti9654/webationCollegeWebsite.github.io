...
<body>
    ...
    <div class="container-fluid pt-5" style="background-color:cadetblue">
        <h1 style="text-align:center;">Upload Assignment</h1>
        <hr
            style="margin-left: 540px; width:30%;height:5px;background-color:orange; border-radius: 20px; border: 2px solid orange;">
        <div class="row pt-3">
            ...
            <div class="col-sm-10"style="background-color: burlywood;">
                <form action="uploadassigndata.php" method="post"enctype="multipart/form-data">
                    <br><br>
                    <label for="Sub"><b>Subject</b></label>
                    <input class="form-control mt-2" type="text" name="subject" id="Sub" /><br><br>
