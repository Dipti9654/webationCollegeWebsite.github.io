...
<div class="container-fluid pt-5" style="background-color:cadetblue">
  <h1 style="text-align:center;">View All Enquiry</h1><hr style="margin-left: 600px; width:20%;height:5px;background-color:orange; border-radius: 20px; border: 2px solid orange;">
    <div class="row pt-3">
        ...
        <div class="col-sm-10">
            <table class="table" style="background-color: burlywood;">
                <tr>
                    ...
                    <th style="background-color: red;">Enquiry</th>
                </tr>
                <?php 
                ...
                <tr>
                    ...
                    <td><?php echo $row['enquirytext']?></td>
                </tr>
                        <?php
                            $i++;
                            }
