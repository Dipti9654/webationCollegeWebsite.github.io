...
<div class="container-fluid pt-5" style="background-color:cadetblue">
    <h1 style="text-align:center;">All View Assignment</h1><hr style="margin-left: 520px; width:30%;height:5px;background-color:orange; border-radius: 20px; border: 2px solid orange;">
    <div class="row pt-3">
        ...
        <div class="col-sm-10">
            ...
            $res = mysqli_query($conn,$query);
                ...
                <tr>
                    ...
                    <td>
                        <a href="../upload1/assignment/<?php echo $row['assignment']; ?>">Download</a>
                    </td>
