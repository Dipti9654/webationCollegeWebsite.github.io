...
<body>
  <!-- navbar  -->
    ...
    <div class="container-fluid pt-5">
        <div class="h1">
        <h1 style="text-align:center">Gallery</h1><hr style="margin-left: 650px; width:20%;height:5px;background-color:red; border-radius: 20px; border: 2px solid red;">
        </div>
        <div class="row pt-5">
            <div class="full-img" id="fullImgBox">
                <img src="images/pexels.jpg" id="fullImg">
                <span onclick="closeFullImg()">X</span>
            </div>
            <div class="img-gallery">
                <img src="images/pexels.jpg.jpeg" onclick="openFullImg(this.src)">
                <img src="images/library.png" onclick="openFullImg(this.src)">
                <img src="images/pexels1.jpg" onclick="openFullImg(this.src)">
                <img src="images/ggps2.jpg" onclick="openFullImg(this.src)">
                <img src="images/faculty.jpg" onclick="openFullImg(this.src)">
                <img src="images/basketball.png" onclick="openFullImg(this.src)">
                <img src="images/pexels2.jpg.jpg" onclick="openFullImg(this.src)">
                <img src="images/gallery.jpg" onclick="openFullImg(this.src)">
                <img src="images/winners.jpg" onclick="openFullImg(this.src)">
                <img src="images/ggps.jpg" onclick="openFullImg(this.src)">
            </div>
